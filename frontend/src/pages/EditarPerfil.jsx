...
export default function EditarPerfil() {
    ...
    return (
        <>
            <AdminNav />
            <h2 className="font-black text-3xl text-center mt-10">Editar Pefil</h2>
            <p className="text-xl mt-5 mb-10 text-center">Modofica tu <span className="text-indigo-600 font-bold">Información aqui</span> </p>
            ...
            <div className="flex justify-center">
                <div className="w-full md:w-1/2 bg-white shadow-lg rounded-lg p-5">
                    ...
                    >
                        ...
                        <input type="submit" value={"Guardar Cambios"} className="bg-indigo-700 px-10 py-3 font-bold text-white rounded-lg uppercase w-full mt-5 hover:bg-indigo-800 transition-colors cursor-pointer" />
                    </form>
                </div>
            </div>
        </>
